...
{ 
    ...
    private Font font;
	private String userName,UserId,MeterNum,HolderName,MeterReading,bill,Month;
	private JButton gobackbttn;

	
	paySlip(String userName,String UserId,String MeterNum,String HolderName,String MeterReading,String bill,String Month){
		...
		unoTF=new JLabel(UserId, SwingConstants.CENTER);
		...
		meternoTF=new JLabel(MeterNum, SwingConstants.CENTER);
		...
		meterReadingTF=new JLabel(MeterReading, SwingConstants.CENTER);
		...
		Bill=new JLabel(bill, SwingConstants.CENTER);
